...
$ServerListFile = "C:\PSTemp\CO.Grant.Servers.txt"   
...
$Outputreport | out-file C:\PSTemp\Test.htm  
Invoke-Expression C:\PSTemp\Test.htm 
##Send email functionality from below line, use it if you want    
$smtpServer = "gcmail.co.grant.wi.gov" 
$smtpFrom = "dandrews@co.grant.wi.gov" 
$smtpTo = "dandrews@co.grant.wi.gov" 
